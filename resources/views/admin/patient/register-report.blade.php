...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
    ...
    <div class="d-flex flex-wrap gap-2">
        <a href="{{ route('admin.patient-register.csv', $exportParams) }}" class="btn btn-outline-success">
            <i class="bi bi-file-earmark-spreadsheet me-1"></i>
            CSV
        </a>
        <a href="{{ route('admin.patient-register.pdf', $exportParams) }}" class="btn btn-outline-danger">
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('admin.patient-register.index') }}" class="row g-3 align-items-end">
            ...
            <tbody>
                @forelse($patients as $patient)
                    <tr>
                        ...
                        <td>{{ number_format($patient->patient_visits_count) }}</td>
                        <td>
                        ...
                        <td class="text-end">
                            <a href="{{ route('admin.patient-register.summary', $patient) }}" class="btn btn-sm btn-outline-primary">
                ...
                @empty
                    <tr>
                        <td colspan="10" class="text-center py-5 text-muted">No patients found for this register period.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
