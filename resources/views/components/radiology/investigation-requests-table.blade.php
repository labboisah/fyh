                    ...
                    <tbody>
                        @forelse ($requests as $index => $investigationRequest)
                            ...
                            <tr wire:key="investigation-request-{{ $investigationRequest->id }}">
                                ...
                                <td class="text-end">
                                    @if ($investigationRequest->bill?->status === 'paid')
                                        <a href="{{ route('radiology.requests.createResult', $investigationRequest) }}"
                                        ...
                                        @if ($investigationRequest->completed_at)
                                            <a href="{{ route('radiology.requests.show', $investigationRequest) }}"
                                               class="btn btn-sm btn-outline-success me-1">
                                                <i class="bi bi-printer"></i>
                                                Print
                                            </a>

                                            <a href="{{ route('radiology.requests.editResult', $investigationRequest) }}"
