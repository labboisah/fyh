<div class="container-fluid py-3" wire:poll.visible.20s="refreshList">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Record and manage payments you collected.</p>
        </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <h3 class="h4 mb-0 text-success">&#8358;{{ number_format($summary['completedAmount'], 2) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">{{ $editingPaymentId ? 'Edit Payment: ' . $paymentId : 'Record Payment' }}</h5>
                ...
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <input type="text"
                               ...
                               wire:model.live.debounce.400ms="billNumber"
                               placeholder="BL2600001"
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
                            ...
                            <tr wire:key="accountant-payment-{{ $payment->id }}">
                                ...
                                <td>
                                    @if($bill && (int) $bill->issued_by === (int) auth()->id() && $bill->issued_date?->isToday())
                                        <a href="{{ route('accountant.bills.show', $bill) }}">{{ $bill->bill_number }}</a>
                                    @elseif($bill)
                                ...
                                <td>{{ $payment->payment_date?->format('M d, Y h:i A') ?? 'N/A' }}</td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('accountant.payments.receipt', $payment) }}" class="btn btn-outline-secondary" title="Receipt">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mt-3">
                <small class="text-muted">Auto-refreshes every 20 seconds while this page is visible.</small>
                {{ $payments->links() }}
            </div>
        </div>
    </div>
