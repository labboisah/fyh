@php
    ...
    $navigationItems = [
        ...
        ['label' => 'Radiology Requests', 'icon' => 'bi-radioactive', 'route' => 'radiology.requests.index', 'patterns' => ['radiology.requests.*'], 'roles' => ['radiologist', 'radiographer'], 'permissions' => ['radiology_request.read'], 'permission_roles' => ['radiologist', 'radiographer']],
        ...
        ['label' => 'Stock', 'icon' => 'bi-box-seam', 'route' => 'pharmacy.stocks.index', 'patterns' => ['pharmacy.stocks.index', 'pharmacy.stocks.create'], 'roles' => ['pharmacist', 'head_of_department'], 'permissions' => ['medicine_stock.read'], 'department_keywords' => ['pharmacy']],
        ['label' => 'Reconciliation', 'icon' => 'bi-clipboard-check', 'route' => 'pharmacy.stocks.reconciliation', 'patterns' => ['pharmacy.stocks.reconciliation'], 'roles' => ['head_of_department'], 'permissions' => ['medicine_stock.read'], 'department_keywords' => ['pharmacy']],
        ...
        ['label' => 'Bills', 'icon' => 'bi-receipt', 'route' => 'accountant.bills.index', 'patterns' => ['accountant.bills.index', 'accountant.bills.create', 'accountant.bills.show', 'accountant.bills.edit'], 'roles' => ['accountant'], 'permissions' => ['bill.read'], 'permission_roles' => ['accountant']],
        ['label' => 'Unpaid Bills', 'icon' => 'bi-receipt-cutoff', 'route' => 'accountant.bills.unpaid', 'patterns' => ['accountant.bills.unpaid'], 'roles' => ['accountant'], 'permissions' => ['bill.read'], 'permission_roles' => ['accountant']],
        ['label' => 'Deleted Bills', 'icon' => 'bi-arrow-counterclockwise', 'route' => 'accountant.bills.deleted', 'patterns' => ['accountant.bills.deleted'], 'roles' => ['accountant'], 'permissions' => ['bill.read'], 'permission_roles' => ['accountant']],
        ['label' => 'Payments', 'icon' => 'bi-credit-card-2-front', 'route' => 'accountant.payments.index', 'patterns' => ['accountant.payments.*'], 'roles' => ['accountant'], 'permissions' => ['payment.read'], 'permission_roles' => ['accountant']],
        ['label' => 'Billing Report', 'icon' => 'bi-file-earmark-text', 'route' => 'reports.finance.index', 'patterns' => ['reports.finance.*'], 'roles' => ['administrator', 'medical_director', 'accountant'], 'permissions' => ['bill.read', 'report.read'], 'permission_roles' => ['administrator', 'medical_director', 'accountant']],
        ['label' => 'Payment Report', 'icon' => 'bi-bar-chart-line', 'route' => 'reports.payments.index', 'patterns' => ['reports.payments.*'], 'roles' => ['administrator', 'medical_director', 'accountant'], 'permissions' => ['payment.read', 'report.read'], 'permission_roles' => ['administrator', 'medical_director', 'accountant']],

        ['label' => 'Bills', 'icon' => 'bi-receipt', 'route' => 'finance.bills.index', 'patterns' => ['finance.bills.*'], 'roles' => ['finance_officer'], 'permissions' => ['bill.read'], 'permission_roles' => ['finance_officer']],
        ['label' => 'Payments', 'icon' => 'bi-credit-card-2-front', 'route' => 'finance.payments.index', 'patterns' => ['finance.payments.*'], 'roles' => ['finance_officer'], 'permissions' => ['payment.read'], 'permission_roles' => ['finance_officer']],
        ['label' => 'Expenses', 'icon' => 'bi-cash-stack', 'route' => 'finance.expenses.index', 'patterns' => ['finance.expenses.*'], 'roles' => ['finance_officer'], 'permissions' => ['expense.read'], 'permission_roles' => ['finance_officer']],
        ['label' => 'Revenues', 'icon' => 'bi-graph-up-arrow', 'route' => 'finance.revenues.index', 'patterns' => ['finance.revenues.*'], 'roles' => ['finance_officer'], 'permissions' => ['revenue.read'], 'permission_roles' => ['finance_officer']],
        ['label' => 'Billing Report', 'icon' => 'bi-file-earmark-text', 'route' => 'reports.finance.index', 'patterns' => ['reports.finance.*'], 'roles' => ['finance_officer'], 'permissions' => ['bill.read', 'report.read'], 'permission_roles' => ['finance_officer']],
        ['label' => 'Payment Report', 'icon' => 'bi-bar-chart-line', 'route' => 'reports.payments.index', 'patterns' => ['reports.payments.*'], 'roles' => ['finance_officer'], 'permissions' => ['payment.read', 'report.read'], 'permission_roles' => ['finance_officer']],
        ...
        ['label' => 'Admissions', 'icon' => 'bi-hospital', 'route' => 'admin.admissions.index', 'patterns' => ['admin.admissions.*'], 'roles' => ['administrator'], 'permissions' => ['admission.read', 'patient.read'], 'permission_roles' => ['administrator']],
        ...
        ['label' => 'Expense Categories', 'icon' => 'bi-tags', 'route' => 'admin.expense-categories.index', 'patterns' => ['admin.expense-categories.*'], 'roles' => ['administrator'], 'permissions' => ['expense.read'], 'permission_roles' => ['administrator']],
        ...
        ['label' => 'Revenue Categories', 'icon' => 'bi-tags-fill', 'route' => 'admin.revenue-categories.index', 'patterns' => ['admin.revenue-categories.*'], 'roles' => ['administrator'], 'permissions' => ['revenue.read'], 'permission_roles' => ['administrator']],
        ...
        ['label' => 'File Types', 'icon' => 'bi-folder2-open', 'route' => 'admin.file-types.index', 'patterns' => ['admin.file-types.*'], 'roles' => ['administrator'], 'permissions' => ['patient.read'], 'permission_roles' => ['administrator']],
        ...
        ['label' => 'Statistics Report', 'icon' => 'bi-bar-chart-line', 'route' => 'medical-director.statistics.index', 'patterns' => ['medical-director.statistics.*'], 'roles' => ['medical_director'], 'permissions' => ['report.read', 'patient.read'], 'permission_roles' => ['medical_director']],
        ['label' => 'Admissions', 'icon' => 'bi-hospital', 'route' => 'medical-director.admissions.index', 'patterns' => ['medical-director.admissions.*'], 'roles' => ['medical_director'], 'permissions' => ['admission.read', 'patient.read'], 'permission_roles' => ['medical_director']],
        ...
        ['label' => 'File Types', 'icon' => 'bi-folder2-open', 'route' => 'medical-director.file-types.index', 'patterns' => ['medical-director.file-types.*'], 'roles' => ['medical_director'], 'permissions' => ['patient.read'], 'permission_roles' => ['medical_director']],
    ...
    $roleIcons = [
        ...
        'lab_technician' => 'bi-clipboard2-pulse',
        'lab_scientist' => 'bi-clipboard2-pulse',
        'radiologist' => 'bi-radioactive',
        'radiographer' => 'bi-radioactive',
        'accountant' => 'bi-cash-stack',
        'finance_officer' => 'bi-bank',
