@php
    ...
    $navigationItems = [
        ...
        ['label' => 'Nurse Patients', 'icon' => 'bi-clipboard-pulse', 'route' => 'nurse.patient.index', 'patterns' => ['nurse.*', 'vital_signs.*'], 'roles' => ['nurse'], 'permissions' => ['vital_sign.read', 'observation.read', 'nursing_note.read'], 'permission_roles' => ['nurse']],
        ['label' => 'Doctor Patients', 'icon' => 'bi-person-vcard', 'route' => 'doctor.patient.index', 'patterns' => ['doctor.*'], 'roles' => ['doctor'], 'permissions' => ['prescription.read', 'admission.read', 'discharge.read'], 'permission_roles' => ['doctor']],
        ...
        ['label' => 'Antenatal Care', 'icon' => 'bi-heart-pulse-fill', 'route' => 'midwife.anc-management', 'patterns' => ['midwife.anc-management'], 'roles' => ['midwife'], 'permissions' => ['antenatal_care.read', 'antenatal_care.create']],
        ['label' => 'Labour', 'icon' => 'bi-activity', 'route' => 'midwife.labour-management', 'patterns' => ['midwife.labour-management'], 'roles' => ['midwife'], 'permissions' => ['labour.read', 'labour.create']],
        ['label' => 'Delivery', 'icon' => 'bi-hospital-fill', 'route' => 'midwife.delivery-management', 'patterns' => ['midwife.delivery-management'], 'roles' => ['midwife'], 'permissions' => ['delivery.read', 'delivery.create']],
        ['label' => 'Newborn', 'icon' => 'bi-bandaid-fill', 'route' => 'midwife.newborn-management', 'patterns' => ['midwife.newborn-management'], 'roles' => ['midwife'], 'permissions' => ['newborn.read', 'newborn.create']],
        ...
        ['label' => 'Postnatal', 'icon' => 'bi-journal-medical', 'route' => 'midwife.postnatal-management', 'patterns' => ['midwife.postnatal-management'], 'roles' => ['midwife'], 'permissions' => ['postnatal_examination.read', 'postnatal_examination.create']],
        ['label' => 'Child Follow-up', 'icon' => 'bi-arrow-repeat', 'route' => 'midwife.child-follow-up-management', 'patterns' => ['midwife.child-follow-up-management'], 'roles' => ['midwife'], 'permissions' => ['child_follow_up.read', 'child_follow_up.create']],
