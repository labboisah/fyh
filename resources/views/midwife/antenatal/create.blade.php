...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="mb-0">New Antenatal Care Record</h1>
            <p class="text-muted">Create antenatal care record for {{ $patient->demographic->first_name ?? 'N/A' }} {{ $patient->demographic->last_name ?? '' }}</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p>{{ $patient->hospital_number }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Patient Name</label>
                            <p>{{ $patient->demographic->first_name ?? 'N/A' }} {{ $patient->demographic->last_name ?? '' }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>{{ $patient->demographic->gender }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-4">
                <div class="card-header bg-light">
                    <h5 class="mb-0">Antenatal Care Details</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('abdominal_examination') is-invalid @enderror" 
                                          ...
                                          rows="2">{{ old('abdominal_examination') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('fetal_movement') is-invalid @enderror" 
                                          ...
                                          rows="2">{{ old('fetal_movement') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('vaginal_examination') is-invalid @enderror" 
                                          ...
                                          rows="2">{{ old('vaginal_examination') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('ultrasound_findings') is-invalid @enderror" 
                                          ...
                                          rows="2">{{ old('ultrasound_findings') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('risk_factors') is-invalid @enderror" 
                                          id="risk_factors" name="risk_factors" rows="2">{{ old('risk_factors') }}</textarea>
                                @error('risk_factors')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('complications') is-invalid @enderror" 
                                          id="complications" name="complications" rows="2">{{ old('complications') }}</textarea>
                                @error('complications')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="complicated" {{ old('status') === 'complicated' ? 'selected' : '' }}>Complicated</option>
                                    <option value="high_risk" {{ old('status') === 'high_risk' ? 'selected' : '' }}>High Risk</option>
                                </select>
                                @error('status')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('management_plan') is-invalid @enderror" 
                                          id="management_plan" name="management_plan" rows="2">{{ old('management_plan') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('counseling_topics') is-invalid @enderror" 
                                          id="counseling_topics" name="counseling_topics" rows="2">{{ old('counseling_topics') }}</textarea>
        ...
        <div class="col-lg-4">
            <div class="card sticky-top" style="top: 20px;">
                ...
                <div class="card-body small">
                    <h6 class="mb-2"><strong>Pregnancy Dating</strong></h6>
                    <p class="text-muted mb-3">
                        Use LMP date to calculate gestational age and EDD (normally 280 days after LMP).
                    </p>

                    <h6 class="mb-2"><strong>Vital Signs</strong></h6>
                    <p class="text-muted mb-3">
                        Record BP, weight, and height. Normal BP in pregnancy is &lt;140/90 mmHg.
                    </p>

                    <h6 class="mb-2"><strong>Fundal Height</strong></h6>
                    <p class="text-muted mb-3">
                        At 20+ weeks, fundal height in cm approximately equals gestational weeks.
                    </p>

                    <h6 class="mb-2"><strong>FHR Range</strong></h6>
                    <p class="text-muted mb-3">
                        Normal fetal heart rate is 110-160 bpm. Check with Doppler from 12+ weeks.
                    </p>

                    <hr>

                    <h6 class="mb-2"><strong>Risk Assessment</strong></h6>
                    <ul class="small text-muted">
                        <li>Age &gt; 35 or &lt; 18 years</li>
                        <li>Hypertension or diabetes</li>
                        <li>Previous complications</li>
