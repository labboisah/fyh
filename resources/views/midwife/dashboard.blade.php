            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <a href="{{ route('midwife.newborn.index') }}" class="btn btn-outline-warning w-100 py-3 text-start">
                                <div class="d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <a href="{{ route('midwife.newborn-examination.index') }}" class="btn btn-outline-info w-100 py-3 text-start">
                                <div class="d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <a href="{{ route('midwife.postnatal-examination.index') }}" class="btn btn-outline-secondary w-100 py-3 text-start">
                                <div class="d-flex align-items-center">
