...
class RequestController extends Controller
{
    ...
    {
        return view('radiograph.request.index');
    }

    public function createResult(InvestigationRequest $investigationRequest)
    {
        return view('radiograph.request.create-result', compact('investigationRequest'));
    }
    ...
    public function storeResult(Request $request, InvestigationRequest $investigationRequest)
    {
        ...
        return redirect()->route('radiograph.requests.index')->with('success', 'Investigation result recorded successfully.');
    }
}
